// // backend/src/services/textExtractor.js
// import fs from 'fs';
...
//       case '.pdf':
//         // Temporarily disable PDF processing
//         throw new Error('PDF processing is temporarily disabled. Please copy and paste your resume text instead, or convert your PDF to a DOCX file.');
...
//       default:
//         throw new Error(`Unsupported file type: ${fileExtension}. Supported formats: DOCX, DOC, TXT (PDF temporarily disabled)`);
//     }
...
//   const allowedExtensions = ['.docx', '.doc', '.txt']; // Removed .pdf temporarily
